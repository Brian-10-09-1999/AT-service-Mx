...
import com.example.devolucionmaterial.activitys.scrollDynamic.PreferencesManager;
...
public class MenuOpciones {
    ...
    public void scrollDynamicInit(Context context){
        Intent intent = new Intent(context, ScrollDynamicActivity.class);
        context.startActivity(intent);
    ...
    public void mostrarInfoApp(Context context) {
        ...
        alertaSimple.setIcon(R.drawable.logozitro2);
        alertaSimple.create();
        alertaSimple.show();
    }
}

...
Esta pensado para realizar una tarea que requiera un largo procesamiento (para tareas cortas se usa ansyctask)
 en segundo plano y después pararse solo.  se ejecuta dentro del  onHandleIntent toda la tarea*/
...
public class ControlTotalLocalxRemoto extends IntentService{
    ...
    void IniciaServiciosEspeciales(String servicio, String fecha_ult_act) {
        ...
        if (servicio.equals("csala")) {
            ...
            //cada vez que se actualizan las tablas de sala tambien lo hacen las de juego
            startService(new Intent(context, ActualizaBDCreaFolios.class));
            BDVarGlo.setVarGlo(context, "VAR_BD_CONTROL_CJUEGOS", fecha_ult_act);
        }

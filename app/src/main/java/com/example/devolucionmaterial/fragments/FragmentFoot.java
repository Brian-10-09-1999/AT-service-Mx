...
import com.example.devolucionmaterial.activitys.scrollDynamic.ScrollDynamicActivity;
...
public class FragmentFoot extends Fragment {
    ...
    Context context;
    View view;
    ImageView img_open_close, img_email, img_call, img_info, img_scroll;
    ...
    void setupFragmentFoot() {
        ...
        img_scroll = (ImageView) view.findViewById(R.id.scrolls);
        ...
        img_scroll.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                menuOpciones.scrollDynamicInit(context);
                //startActivity(new Intent(FragmentFoot.this, ScrollDynamicActivity.class));
    ...
    void animClose(){
        ...
        Picasso.with(context).load(R.drawable.btn_up).into(img_open_close);
    }
    void animOpen(){
        ...
        Picasso.with(context).load(R.drawable.btn_down).into(img_open_close);
    }

...
public class ChatListFragment extends Fragment implements ListChatAdapter.ClickListener, ListChatAdapter.OnUpdate, View.OnClickListener {
    Context context;
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        floatingActionButton = (FloatingActionButton) v.findViewById(R.id.fcl_fab_chat);

...
public class BDVarGlo {
    ...
    public static void INICIALIZA(Context context1) {
        ...
        //VALORES DE LA APP
        setVarGlo(context, "INFO_APP_SERVIDOR_VERSION", "0");
        //FUNCIONES DE CONEXION CON android.php
        ...
        setVarGlo(context, "URL_DOMINIO_PRODUCCION", "http://189.254.111.195:8082/");
        setVarGlo(context, "URL_DOMINIO_PRODUCCION_LOCAL", "http://10.10.0.11:8082/");

...
public class CustomImageView extends ImageView implements View.OnTouchListener {
    ...
    public void setBitmap(Bitmap bitmap){
        ...
        if(bitmap != null){
            ...
            MensajeEnConsola.log(context, metodo, "mBitmapWidth = "+mBitmapWidth+
                            "\nmBitmapHeight = "+mBitmapHeight+
                            "\nmBitmapMiddlePoint.x = "+mBitmapMiddlePoint.x+
                            "\nmBitmapMiddlePoint.y = "+mBitmapMiddlePoint.y
                            );

...
public class BDmanager {
    ...
    public ContentValues generarContentValuesDescripcionSalidas(int fkSalida, int codigo, String descripcion, int cantidad, String noSerie, String estatus) {
        ContentValues valores = new ContentValues();
    ...
    //Inserta en una fila de la tabla los campos solicitados
    public void insertarSalida(int fksala, int noSalida, int usuario, String fecha, String status,
                               String folio, int office, String pedido, String noGuia, String tipo, String tecnicoidBaja) {
        db.insert(TABLE_SALIDAS, null, generarContentValuesSalidas(fksala, noSalida, usuario,
                fecha, status, folio, office, pedido, noGuia, tipo, tecnicoidBaja));
    }

    //Inserta en una fila de la tabla los campos solicitados
    public void insertarDescripcionSalida(int fkSalida, int codigo, String descripcion, int cantidad, String noSerie, String estatus) {
        db.insert(TABLE_DESCRIPCION_SALIDA, null, generarContentValuesDescripcionSalidas(fkSalida, codigo, descripcion, cantidad, noSerie, estatus));
    }
    ...
    public Cursor cargarCursorSalidas() {
        ...
        return db.query(TABLE_SALIDAS, columnas, null, null, null, null, null);
    }
